...
import { Plus, Clock, User, Phone, Mail, Star, Calendar as CalendarIcon, X, Edit } from 'lucide-react';
import { Doctor, Appointment } from '@/lib/mockData';
import { getDoctors, getAppointments, saveAppointment, updateAppointmentStatus } from '@/lib/storage';
...
const StaffAppointments = () => {
  ...
  const loadData = () => {
    ...
    // Filter doctors based on staff's assigned doctors
    const assignedDoctorIds = user?.assignedDoctors || [];
    const filteredDoctors = allDoctors.filter(d => assignedDoctorIds.includes(d.id));
  ...
  const handleEditAppointment = (appointment: Appointment) => {
    if (appointment.status === 'cancelled') {
      toast.error('Cannot edit a cancelled appointment');
      return;
    }
      ...
      <div className="space-y-6 animate-fade-in">
        <div className="flex items-center justify-between">
          <div>
            ...
            <p className="text-muted-foreground mt-2">Manage appointments</p>
          </div>
          {selectedDoctor && (
        ...
        <div className="grid lg:grid-cols-12 gap-6">
          ...
          <div className="lg:col-span-3 space-y-4">
            <Card className="glass-card">
              <CardHeader>
                <CardTitle className="text-lg">My Providers</CardTitle>
              </CardHeader>
            ...
            {selectedDoctor ? (
              ...
              <Card className="glass-card">
                <CardContent className="text-center py-12">
                  ...
                  <p className="text-muted-foreground">No providers assigned to you yet</p>
                </CardContent>
              </Card>
            )}
          </div>
          ...
          <AlertDialogContent className="glass-card">
            <AlertDialogHeader>
              ...
              <AlertDialogDescription>
                This will cancel the appointment. This action can be reversed later if needed.
              </AlertDialogDescription>
            </AlertDialogHeader>
            <AlertDialogFooter>
